...
], function($, User, date, loginMenu, discussionEventTemplate){
	return {
		...
		parseDiscussionEvent : function(recipename, syntax, eingefuegt, versions_id, nickname) {
			var text = syntax;
		...
		getChildComment : function(user, id){
