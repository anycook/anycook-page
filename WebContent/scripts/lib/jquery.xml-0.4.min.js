...
access:b}),!d.settings.error.apply(d.target,[b]))return;d=c.clone().contents();d=a("<div/>").append(d);d.find("br").replaceWith("<br/>");$el.append(d.html());e&&e.apply($el)},loadXml:function(c){var d=a.Deferred();a.ajax({url:c,dataType:"text",success:function(b){b=a.parseXML(b);d.resolve(a(b))},error:function(a){console.error(a.responseText)}});$xmlDoc=a(null);return d.promise()}}})(jQuery,window,document);
